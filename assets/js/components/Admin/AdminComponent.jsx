...
import AdminCorrectPersonComponent from './AdminCorrectPersonComponent.jsx'
import AdminTitleComponent from './AdminTitleComponent.jsx'
// action, stores
...
class Question extends Component {
  ...
  // 問題公開
  handleOpenClick() {
    if(this.state.buttonStatus.open.text === 'Choices') {
      console.log('openChoices');
      buttonAction.openChoicesButton();
      socketAction.broadcastChoices(this.props.id, this.props.text);
    } else {
      console.log('open');
